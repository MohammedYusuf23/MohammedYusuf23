...
- 🔭 Currently working as **Quality Checker at ITC Limited** while growing as a dev
- 🌱 Learning **Next.js & Node.js** to go full-stack
- 💡 Passionate about building **responsive, accessible, and fast UIs**
- 🎯 Skilled in **React, Redux Toolkit, REST APIs, and modern frontend architecture**
- 🤝 Open to **frontend developer roles & freelance projects**
- 📫 Reach me at **yusufchota7@gmail.com**
- 🗣️ Languages: **English · Hindi · Tamil (Native)**
...
<details>
<summary>🏢 <strong>ITC Limited</strong> — Quality Checker &nbsp;|&nbsp; Jan 2026 – Present &nbsp;|&nbsp; Chennai, India</summary>

<br/>

> `Quality Inspection` `Process Compliance` `Team Collaboration` `Attention to Detail`

- ✅ Performing quality inspection and verification processes to ensure product standards and operational accuracy across daily workflows
- 🔍 Maintaining high consistency and compliance to process guidelines, reducing defect pass-through rates
- 🤝 Collaborating cross-functionally with team members to identify workflow inefficiencies and implement improvements
- 📋 Applying analytical thinking to ensure operational accuracy and adherence to production benchmarks

</details>

<details>
<summary>💻 <strong>Kapital Kapslock</strong> — Full Stack Developer Intern &nbsp;|&nbsp; Nov 2025 – Dec 2025 &nbsp;|&nbsp; Remote</summary>

<br/>

> `React.js` `JavaScript` `Tailwind CSS` `Frontend-Backend Integration` `Debugging` `Testing`

- ⚛️ Developed responsive frontend components using React, JavaScript, and Tailwind CSS, contributing to a live production codebase
- 🔁 Built reusable UI components that improved application performance and code maintainability across the project
- 🔗 Worked on frontend-backend integration, connecting REST APIs to UI features and ensuring smooth data flow
- 🐛 Actively participated in debugging and testing workflows, improving code reliability and user experience
...
| 🏆 | Achievement | Details |
|:--:|:------------|:--------|
| 🎓 | **HTML, CSS & JavaScript** — Coursera | Completed 2024 |
| 🎓 | **Front-End Development** — Udemy | Completed 2024 |
| 🎓 | **Front-End Development (Offline)** — Magic Bus Foundation | Completed 2025 |
| 👥 | **Team Lead — Vibe Stream** | Led 4-member team · 50% productivity boost · 5 on-time milestones |
| 💻 | **Internship Graduate — Kapital Kapslock** | Full Stack Developer Intern · Nov–Dec 2025 |
| 🌐 | **Multi-language Proficiency** | English · Hindi · Tamil (Native) |
...
|:-------|:------------|:----:|:-----:|
| Bachelor of Computer Science | Shree Chandra Prabu Jain College, Minjur | Jun 2021 – Apr 2024 | 70% |
...
⚙️  Node.js        → Express, REST APIs, Middleware
🔷  TypeScript     → Advanced Types, Generics, Decorators
🏗️  System Design  → Scalable Architecture, Component Patterns
🔐 Auth Flows     → JWT, OAuth2, Session Management
```
